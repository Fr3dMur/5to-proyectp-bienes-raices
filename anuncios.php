<?php  include 'includes/templates/header.php';?>
    ...
    <main class="contenedor seccion">
            ...
            <div class="contenedor-anuncios">
                ...
                <div class="anuncio">
                    <picture>
                        <source srcset="build/img/anuncio4.webp" type="image/webp" alt="Imagen de una casa">
                        <source srcset="build/img/anuncio4.jpg" type="image/jpeg" alt="Imagen de una casa">
                        <img loading="lazy" src="build/img/anuncio4.jpg" alt="Imagen de una casa">
                    </picture>
                    <div class="contenido-anuncio">
                        <h3>Casa de Lujo en el Lago</h3>
                        <p>Casa en el Lago con excelente vista, acabados de lujo a un excelente precio</p>
                ...
                <div class="anuncio">
                    <picture>
                        <source srcset="build/img/anuncio5.webp" type="image/webp" alt="Imagen de una casa">
                        <source srcset="build/img/anuncio5.jpg" type="image/jpeg" alt="Imagen de una casa">
                        <img loading="lazy" src="build/img/anuncio5.jpg" alt="Imagen de una casa">
                    </picture>
                    <div class="contenido-anuncio">
                        <h3>Casa terminados de lujo</h3>
                        <p>Casa en el Lago con excelente vista, acabados de lujo a un excelente precio</p>
                ...
                <div class="anuncio">
                    <picture>
                        <source srcset="build/img/anuncio6.webp" type="image/webp" alt="Imagen de una casa">
                        <source srcset="build/img/anuncio6.jpg" type="image/jpeg" alt="Imagen de una casa">
                        <img loading="lazy" src="build/img/anuncio6.jpg" alt="Imagen de una casa">
                    </picture>
                    <div class="contenido-anuncio">
                        <h3>Casa con Alberca</h3>
                        <p>Casa en el Lago con excelente vista, acabados de lujo a un excelente precio</p>
