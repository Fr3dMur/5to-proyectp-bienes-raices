...
?>
    <main class="contenedor seccion contenido-centrado">
        ...
        <article class="entrada-blog">
            <div class="imagen">
                <picture>
                    <source srcset="build/img/blog3.webp" type="image/webp" alt="Texto Entrada Blog">
                    <source srcset="build/img/blog3.jpg" type="image/jpeg" alt="Texto Entrada Blog">
        ...
        <article class="entrada-blog">
            <div class="imagen">
                <picture>
                    <source srcset="build/img/blog4.webp" type="image/webp" alt="Texto Entrada Blog">
                    <source srcset="build/img/blog4.jpg" type="image/jpeg" alt="Texto Entrada Blog">
